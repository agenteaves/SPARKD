...
// contest-rules.js v1.0
//
// Standalone frontend module.
// Injects a Contest Rules button beside the current
// week/date heading above the large winner box.
//
// Does NOT modify contest-submit.js, voting.js,
// lifecycle logic, winner selection, or Supabase writes.
////////////////////////////////////////////////////
  ...
  const RULE_SECTIONS = [
    ...
    },
    {
      ...
      items: [
        ...
        "Community promotion does not override the one-wallet-one-vote rule."
      ]
    },
    {
      title: "7. How the Winner Is Chosen",
      items: [
